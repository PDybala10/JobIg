...
import com.example.ndesigne.job2.model.Competence;
import com.example.ndesigne.job2.model.ExprPro;
import com.example.ndesigne.job2.model.Formation;
import com.example.ndesigne.job2.model.Langue;
import com.example.ndesigne.job2.view.ui.cv.CompetenceFragment;
import com.example.ndesigne.job2.view.ui.cv.DetailsCvFragment;
import com.example.ndesigne.job2.view.ui.cv.ExperienceFragment;
import com.example.ndesigne.job2.view.ui.cv.FormationFragment;
import com.example.ndesigne.job2.view.ui.cv.InterestFragment;
import com.example.ndesigne.job2.view.ui.cv.LangueFragment;
...
public class MakeCvActivity extends AppCompatActivity {
    ...
    public void makeHiscv(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= VERSION_CODES.KITKAT) {
            ...
            String directoriePath = Environment.getExternalStorageDirectory().getPath()+ "/JobIg/doc/";
            File file = new File(directoriePath);
            if(!file.exists()){
                file.mkdirs();
            }

            String targetPdf =directoriePath + "myCv.pdf";
